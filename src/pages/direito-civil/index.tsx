...
const DireitoCivil = () => {
    ...
    const direito_civil = t.expertise_data[7];

    return (
        <>
            <Head>
                <title>{direito_civil.head_title}</title>
                <meta name="description" content={direito_civil.head_description} />
                ...
                <section>
                    <div className="Container Dark_Container Unpadded_Container Expertise_Header Low_Container Ungaped_Container">
                        <div className="Expertise_Header_Top">
                            ...
                            <Image className="Expertise_Header_Img" src={direito_civil.image} alt={"Direito Aduaneiro"} width={800} height={400} />
                        </div>
                        <div className="Expertise_Header_Info">
                            <h2 className="Expertise_Header_Info_Subtitle">{t.common.area_of_expertise}</h2>
                            <h1 className="Expertise_Header_Info_Title">{direito_civil.name}</h1>
                            <p className="Expertise_Header_Info_Description">{direito_civil.head_description}</p>
                    ...
                    <div className="Container Services_List_Container">
                        <div className="Services_List">
                            {direito_civil.expertises.map((service: any) => (
