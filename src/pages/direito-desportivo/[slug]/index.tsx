...
import { Banners_Data, Servicos_Desportivo, Service_Data } from "@/data/Expertises";

import WhatsAppBtn from "@/components/WhatsAppBtn";

export const getStaticPaths: GetStaticPaths = async () => {
    // Get the paths we want to pre-render based on services
    const paths = Servicos_Desportivo.map((service) => ({
                ...
                <section>
                    <div className="Container Dark_Container Unpadded_Container Ungaped_Container Expertise_Header Low_Container">
                        ...
                        <div className="Expertise_Header_Info">
                            <h2 className="Expertise_Header_Info_Subtitle">DIREITO DESPORTIVO</h2>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    const service = Servicos_Desportivo.find((service) => service.slug === params.slug);
