...
export const getStaticPaths: GetStaticPaths = async () => {
    ...
    const paths = Servicos_Empresarial.map((service) => ({
                ...
                <section>
                    <div className="Container Dark_Container Unpadded_Container Ungaped_Container Expertise_Header Low_Container">
                        ...
                        <div className="Expertise_Header_Info">
                            <h2 className="Expertise_Header_Info_Subtitle">DIREITO EMPRESARIAL</h2>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    const service = Servicos_Empresarial.find((service) => service.slug === params.slug);
