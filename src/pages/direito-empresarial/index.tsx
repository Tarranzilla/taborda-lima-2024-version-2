...
import { Expertise_Data, Banners_Data, Servicos_Empresarial } from "@/data/Expertises";
...
const Direito_Empresarial_Data = Banners_Data[4];

const DireitoEmpresarial = () => {
    return (
        <>
            <Head>
                <title>Direito Empresarial | Taborda Lima & Advogados Associados</title>
                    ...
                    <div className="Container Dark_Container Unpadded_Container Expertise_Header Low_Container Ungaped_Container">
                        <div className="Expertise_Header_Top">
                            ...
                            <Image
                                ...
                                src={Direito_Empresarial_Data.image}
                        ...
                        <div className="Expertise_Header_Info">
                            ...
                            <h1 className="Expertise_Header_Info_Title">{Direito_Empresarial_Data.title}</h1>
                            <p className="Expertise_Header_Info_Description">{Direito_Empresarial_Data.description}</p>
                        </div>
                    </div>

                    <div className="Container Services_List_Container">
                        <div className="Services_List">
                            {Servicos_Empresarial.map((service) => (
