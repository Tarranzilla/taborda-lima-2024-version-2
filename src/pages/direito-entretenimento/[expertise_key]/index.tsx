...
import { direito_entretenimento_EN } from "@/content-list/services/english";
import { direito_entretenimento_PT } from "@/content-list/services/portuguese";

import { useSimpleTranslation } from "@/international/use_translation";
import { direito_entretenimento_ES } from "@/content-list/services/spanish";

export const getStaticPaths: GetStaticPaths = async () => {
    const paths: { params: { expertise_key: string }; locale: string }[] = [];

    const expertises_PT = direito_entretenimento_PT.expertises;
    const expertises_EN = direito_entretenimento_EN.expertises;
    const expertises_ES = direito_entretenimento_ES.expertises;
...
const ServicePage = ({ expertise }: { expertise: Expertise | null }) => {
    ...
    return (
        <>
            ...
            <m.main
                variants={commonTransition}
                initial="hidden"
                animate="visible"
                exit="exit"
                key={"pagina_direito_entretenimento_" + expertise.slug}
            >
                    ...
                    <div className="Container Dark_Container Unpadded_Container Ungaped_Container Expertise_Header Low_Container">
                        <div className="Expertise_Header_Top">
                            <div className="Expertise_Header_Top_Nav">
                                ...
                                <Link href={"/direito-entretenimento"} scroll={false} className="Page_Button Expertise_Header_Top_Nav_Button">
                                    <span className="material-icons">arrow_back</span>
                                    <p>{t.common.returnToEntertainmentLaw}</p>
                                </Link>
                            </div>
