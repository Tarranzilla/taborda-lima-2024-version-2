...
import { direito_migratorio_EN } from "@/content-list/services/english";
import { direito_migratorio_PT } from "@/content-list/services/portuguese";

import { useSimpleTranslation } from "@/international/use_translation";
import { direito_migratorio_ES } from "@/content-list/services/spanish";

export const getStaticPaths: GetStaticPaths = async () => {
    const paths: { params: { expertise_key: string }; locale: string }[] = [];

    const expertises_PT = direito_migratorio_PT.expertises;
    const expertises_EN = direito_migratorio_EN.expertises;
    const expertises_ES = direito_migratorio_ES.expertises;
                        ...
                        <div className="Expertise_Header_Top">
                            <div className="Expertise_Header_Top_Nav">
                                ...
                                <Link href={"/direito-migratorio"} scroll={false} className="Page_Button Expertise_Header_Top_Nav_Button">
                                    <span className="material-icons">arrow_back</span>
                                    <p>{t.common.returnToImmigrationLaw}</p>
                                </Link>
                            </div>
