...
export const getStaticPaths: GetStaticPaths = async () => {
    ...
    const expertises_PT = Exepertise_Data_PT[7].expertises;
    const expertises_EN = Exepertise_Data_EN[7].expertises;
    ...
    return (
        <>
            ...
            <m.main
                ...
                animate="visible"
                exit="exit"
                key={"pagina_mercado_de_capitais_investimento_estrangeiro" + expertise.slug}
            >
                    ...
                    <div className="Container Dark_Container Unpadded_Container Ungaped_Container Expertise_Header Low_Container">
                        <div className="Expertise_Header_Top">
                            <div className="Expertise_Header_Top_Nav">
                                ...
                                <Link
                                    href={"/mercado-de-capitais-e-investimento-estrangeiro"}
                                    scroll={false}
                                    className="Page_Button Expertise_Header_Top_Nav_Button"
                                >
                                    <span className="material-icons">arrow_back</span>
                                    <p>{t.common.returnToMarketLaw}</p>
                                </Link>
                            </div>
